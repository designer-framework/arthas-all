...
public class AgentMethodInvokeImportBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry registry) {
        ...
        annotationMetadata.getAnnotations().stream(EnabledMethodInvokeWatch.class)
                ...
                .forEach(methodInvokeWatch -> {
                    ...
                    AgentMethodInvokeRegistryPostProcessor.registry(registry,
