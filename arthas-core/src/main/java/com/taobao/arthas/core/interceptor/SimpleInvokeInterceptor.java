 ...
 */
@Component
public class SimpleInvokeInterceptor extends InvokeInterceptorAdapter {
    ...
    @Autowired
    private List<MethodInvokeListener> methodInvokeListeners;
    ...
    public void before(ClassLoader loader, Class<?> clazz, String methodName, String[] methodArgumentTypes, Object target, Object[] args) {
        ...
        methodInvokeListeners.forEach(invokeAdviceHandler -> {
